def main():
    brawler_a = Brawler("Aragorn", 4, 4)
    brawler_g = Brawler("Gimli", 2, 7)
    brawler_l = Brawler("Legolas", 7, 7)
    brawler_f = Brawler("Frodo", 3, 2)
    fight(brawler_a, brawler_g)
    fight(brawler_l, brawler_f)
